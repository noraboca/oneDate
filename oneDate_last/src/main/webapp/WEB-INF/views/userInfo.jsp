        ...
        <form action="update" method="post" enctype="multipart/form-data">
            ...
            <div style="margin-top: 30px;">
                <div class="id">
                    ...
                    <div class="lb">
                        ...
                        <input type="text" id="user_id" name="id" value="${vo.id}"
                ...
                <div class="password">
                    ...
                    <div class="lb">
                        ...
                        <input type="password" id="user_pw" name="password" value="${vo.password}"
            ...
            <div>
                <div class="email">
                    ...
                    <div class="lb">
                        ...
                        <input type="text" id="user_mail" name="email" value="${vo.email}" readonly>
                    </div>
                </div>
                <div class="birthday">
                    <span style="color: #e33988; float: left;">*&nbsp;&nbsp;</span>
                    ...
                    <div class="lb">
                        ...
                        <input type="hidden" id="birth_day" name="birth_day" value="${vo.birth_day}">
                    </div>
                </div>
            </div>
            <div style="margin-top: 30px;">
                <div class="phone">
                    ...
                    <div class="lb">
                        ...
                        <input type="text" id="phone" name="phone" value="${vo.phone}" 
                        	maxlength="11" placeholder="' - '를 제외한 숫자만 입력" required>
                            <div class="sms">
                ...
                <div class="gender">
                    ...
                    <div class="gender_box">
                        <input type="hidden" id="getGender2" value="${vo.interested_gender }">
            ...
            <div style="text-align: left; margin-left: 40px;">
                <div class="address">
                    ...
                    <div class="lb">
                        ...
                        <input type="text" id="address" name="address" value="${vo.address }"required readonly>
            ...
            <div style="text-align: left; margin-left: 40px;">
                <div class="details">
                    ...
                    <div class="lb">
                        <textarea id="details" name="details" placeholder="자신을 간단히 소개해 주세요~" 
                        	maxlength="200">${vo.details }</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="hobby" style="text-align: left; margin-left: 70px; margin-top: 50px;">
                ...
                <div class="str_box">
                    <input type="text" id="hobby" name="hobby" value="${vo.hobby}"
