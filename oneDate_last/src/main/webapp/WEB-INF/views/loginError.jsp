...
<body>
    <div class="container">
        ...
        <h1>OneDate 로그인</h1>
        <div class="err_box">
            <span id="err_msg">입력하신 아이디와 비밀번호가 등록된 정보와 일치하지 않습니다. 확인 후 다시 시도하세요.</span>
        </div>
        <form action="loginCheck" method="post">
            <div class="id_box">
                <span id="text1">이메일 또는 사용자 아이디</span><br/>
                <input type="text" class="input_id" name="emailOrId" value="${emailOrId}" autofocus><br/>
            </div>
            ...
            <div class="kakao" style="margin-bottom: 20px;">
                <a href="javascript:openWindow('${kakaoUrl }')">
                    <img src="resources/images/login_kakao.jpg" width= 270px; height= 40px;></a>
            </div>
            <div class="naver" style="margin-bottom: 20px;">
                <a href="javascript:openWindow('${naverUrl }')">
